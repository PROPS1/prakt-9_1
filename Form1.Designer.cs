namespace prakt_9_1
{
  partial class Form1
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.label1.Text = "хотите выиграть в казино?";
      // 
      // button1
      // 
      ...
      this.button1.Text = "чтоб это делать";
      ...
      this.button2.Text = "ты кто такой?\r\n";
      ...
      this.BackgroundImage = global::prakt_9_1.Properties.Resources.ebanyy_rot_etogo_kazino;
